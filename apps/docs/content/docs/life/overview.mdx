...
The system is organized as a Rust workspace with 12 active subsystems across 142 crates, totaling over 310,593 lines of Rust. All crates use Rust 2024 Edition with MSRV 1.85 (the Spaces WASM module uses Rust 2021 Edition as required by SpacetimeDB).

<Callout type="info">
  **Current metrics:** v0.3.0 with 4,877 test functions across 657 test files. All tests pass.
</Callout>
