...
The system is organized as a Rust workspace with 61 crates across 8 subsystems, totaling over 130,000 lines of Rust. All crates use Rust 2024 Edition with MSRV 1.85 (the Spaces WASM module uses Rust 2021 Edition as required by SpacetimeDB).
...
- Vigil scaffolded, Chronos/Aegis/Nous/Mnemo not yet started
