...
<Cards>
  <Card title="AI Chat" href="/docs/platform/chat" description="Multi-model conversations with Claude, GPT, Gemini, and local models via Ollama. Memory vault, deep research, MCP tool integration." />
  <Card title="Agent OS" href="/docs/life/overview" description="Run the full Life runtime locally — Arcan agent loop, Lago persistence, Autonomic regulation, Haima finance, Spaces networking." />
  <Card title="CLI Tooling" href="/docs/cli/installation" description="Manage prompts, skills, and agent context from your terminal. Device-code authentication, daemon mode for local agent runtimes." />
  <Card title="Platform Console" href="/docs/platform/console" description="Multi-tenant organization management, usage analytics, API key provisioning, and deployment configuration." />
</Cards>
...
<Steps>
  ...
  <Step>
    ### Read the quickstart
    Follow the [Quickstart Guide](/docs/quickstart) to set up an organization, install the CLI, and make your first API call.
  </Step>
  <Step>
    ### Explore Life
    Dive into the [Agent OS architecture](/docs/life/overview) to understand how Arcan, Lago, Autonomic, Haima, and Spaces work together.
  </Step>
</Steps>
