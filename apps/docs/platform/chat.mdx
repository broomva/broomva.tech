...
Model selection is available from the dropdown at the top of the chat interface. Different models have different capabilities and costs — see [Billing](/platform/billing) for credit consumption rates.
