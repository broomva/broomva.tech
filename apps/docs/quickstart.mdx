...
<CardGroup cols={2}>
  <Card title="Platform Chat" icon="message" href="/platform/chat">
    Review current chat features, model-selection rules, and
    deployment-dependent memory.
  </Card>
  <Card title="API Reference" icon="code" href="/api-reference/overview">
    API reference material covering authentication, selected endpoints, and error handling.
  </Card>
  <Card title="CLI Commands" icon="terminal" href="/cli/commands">
    CLI reference material for documented commands and options.
  </Card>
  <Card title="Agent OS" icon="microchip" href="/life/overview">
    Understand the Life architecture and run the agent runtime locally.
  </Card>
</CardGroup>

## What's next

- **Review plan options** — [billing](/platform/billing) documents current allocations and the default-off paid launch gate
- **Deploy a managed instance** — run your own [Life agent runtime](/platform/deployments) in the cloud
- **Build with the SDK** — use the [TypeScript SDK](/sdk/typescript) to integrate Broomva into your applications
