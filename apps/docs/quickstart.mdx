...
<CardGroup cols={2}>
  <Card title="Platform Chat" icon="message" href="/platform/chat">
    Deep dive into chat features, model selection, and memory vault.
  </Card>
  <Card title="API Reference" icon="code" href="/api-reference/overview">
    Full API documentation with authentication, endpoints, and error handling.
  </Card>
...
- **Upgrade your plan** — the [Pro tier](/platform/billing) gives you 5,000 credits/month and access to all models
