...
tags:
  ...
  - open-source
  - skill-library
image: /images/writing/capx-agentic-robotics/hero-opt.png
audio: /audio/writing/capx-agentic-robotics.mp3
---

![A Franka Panda robot arm connected to an LLM generating Python manipulation code](/images/writing/capx-agentic-robotics/hero-opt.png)
...
![CaP-X pipeline: LLM generates Python code that composes perception and control APIs](/images/writing/capx-agentic-robotics/architecture-opt.png)
