...
Priority on RCS is established by the public commit history of [github.com/broomva/rcs](https://github.com/broomva/rcs). Every theorem, every revision, every Instantiation Catalogue row maps to a timestamped commit with a verifiable SHA on a public repository. The paper's 12 merged PRs — the D2 architecture-agnostic reframe, the D2.1 CodeRabbit fixes, the D2.2 prop:triple regime conditions, the Appendix A LQR worked example, the π₀-family instantiation added today — form a referenceable ledger.
