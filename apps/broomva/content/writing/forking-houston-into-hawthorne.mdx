...
<style>
.fkx-top{margin:30px 0;border-radius:18px;border:1px solid var(--ag-border-default);background:linear-gradient(160deg,color-mix(in oklab,var(--ag-ai-blue) 16%,var(--ag-bg-surface)),var(--ag-bg-surface));padding:22px 24px;box-shadow:var(--ag-shadow-glow-blue)}
.fkx-top .fkx-k{font-family:ui-monospace,"SF Mono",Menlo,monospace;font-weight:700;font-size:11px;letter-spacing:.2em;text-transform:uppercase;color:var(--ag-accent-blue)}
.fkx-top .fkx-lede{margin:10px 0 16px;color:var(--ag-text-secondary);font-size:15px;line-height:1.6;max-width:720px}
.fkx-top .fkx-lede a{color:var(--ag-ai-blue);font-weight:600}
.fkx-row{display:flex;flex-wrap:wrap;gap:8px}
.fkx-row.fkx-stats{margin-bottom:14px}
.fkx-stat{font-family:ui-monospace,"SF Mono",Menlo,monospace;font-size:12px;color:var(--ag-text-muted);border:1px solid var(--ag-border-subtle);border-radius:999px;padding:8px 12px;background:var(--ag-bg-elevated)}
.fkx-stat b{color:var(--ag-text-primary);font-weight:800}
.fkx-pill{font-size:12px;font-weight:600;color:var(--ag-ai-blue);border:1px solid color-mix(in oklab,var(--ag-ai-blue) 38%,transparent);border-radius:8px;padding:6px 10px;background:color-mix(in oklab,var(--ag-ai-blue) 10%,transparent)}
.fkx-wrap{margin:8px 0 4px}
.fkx-statstrip{display:grid;grid-template-columns:repeat(5,1fr);gap:12px;margin:6px 0 20px}
.fkx-statstrip .s{border:1px solid var(--ag-border-subtle);border-radius:14px;background:var(--ag-bg-elevated);padding:14px 16px}
.fkx-bignum{display:block;font-weight:800;font-size:23px;line-height:1;letter-spacing:-.02em;color:var(--ag-text-primary)}
.fkx-biglabel{display:block;font-family:ui-monospace,"SF Mono",Menlo,monospace;font-size:10.5px;line-height:1.3;color:var(--ag-text-muted);text-transform:uppercase;letter-spacing:.05em;margin-top:7px}
.fkx-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:14px;margin:0}
.fkx-card{border:1px solid var(--ag-border-default);border-radius:16px;background:linear-gradient(180deg,var(--ag-bg-elevated),var(--ag-bg-surface));padding:18px 20px;transition:transform .15s ease,border-color .15s ease}
.fkx-card:hover{transform:translateY(-3px);border-color:var(--ag-border-focus)}
.fkx-card .hd{display:flex;align-items:flex-start;gap:10px;margin-bottom:8px}
.fkx-ic{width:32px;height:32px;flex:none;border-radius:9px;display:grid;place-items:center;font-size:16px;background:color-mix(in oklab,var(--ag-ai-blue) 15%,transparent);border:1px solid var(--ag-border-subtle)}
.fkx-card .ti{font-weight:700;font-size:15px;line-height:1.2;color:var(--ag-text-primary)}
.fkx-tag{margin-left:auto;font-family:ui-monospace,"SF Mono",Menlo,monospace;font-weight:600;font-size:9.5px;text-transform:uppercase;letter-spacing:.06em;color:var(--ag-text-muted);border:1px solid var(--ag-border-subtle);border-radius:999px;padding:4px 8px;white-space:nowrap}
.fkx-card p{margin:0;color:var(--ag-text-secondary);font-size:13.5px;line-height:1.55}
.fkx-crate{font-family:ui-monospace,"SF Mono",Menlo,monospace;font-weight:700;font-size:12px;color:var(--ag-accent-blue);margin:0 0 2px}
.fkx-list{list-style:none;margin:8px 0 0;padding:0}
.fkx-list li{position:relative;padding:6px 0 6px 18px;margin:0;color:var(--ag-text-secondary);font-size:13.5px;line-height:1.5;border-top:1px dashed var(--ag-border-subtle)}
.fkx-list li:first-child{border-top:none}
.fkx-list li:before{content:"\25B8";position:absolute;left:0;color:var(--ag-ai-blue)}
.fkx-chip{display:inline-block;font-family:ui-monospace,"SF Mono",Menlo,monospace;font-weight:700;font-size:9.5px;text-transform:uppercase;letter-spacing:.04em;border-radius:6px;padding:3px 6px;margin-left:6px;vertical-align:middle}
.fkx-chip.live{color:#04140d;background:var(--ag-success)}
.fkx-legend{display:flex;gap:16px;flex-wrap:wrap;margin:0 0 16px;font-family:ui-monospace,"SF Mono",Menlo,monospace;font-size:12px;color:var(--ag-text-muted)}
.fkx-legend .dot{display:inline-block;width:9px;height:9px;border-radius:3px;margin-right:6px;vertical-align:middle}
.fkx-feature-lede{color:var(--ag-text-secondary);font-size:15px;line-height:1.6;margin:0 0 18px;max-width:760px}
.fkx-note{border-left:3px solid var(--ag-warning);background:color-mix(in oklab,var(--ag-warning) 8%,transparent);border-radius:0 12px 12px 0;color:var(--ag-text-secondary);font-size:13px;line-height:1.55;margin:16px 0 0;padding:12px 15px}
@media(max-width:720px){.fkx-statstrip{grid-template-columns:repeat(2,1fr)}.fkx-grid{grid-template-columns:1fr}}
</style>

<div class="fkx-top">
<div class="fkx-k">What the fork adds</div>
<p class="fkx-lede">Eighty-nine commits of net-new surface grafted onto an MIT body: <strong>four new Rust crates</strong>, a full Linear tracker, a feature-flag platform, a push pipeline, and a per-agent cloud-isolation plane. The complete card grid is <a href="#what-the-fork-adds">at the bottom of this post&nbsp;↓</a> — or open the full interactive showcase <a href="https://broomva.tech/d/hackathon-fork-inventory" target="_blank" rel="noopener">here&nbsp;→</a>.</p>
<div class="fkx-row fkx-stats">
<span class="fkx-stat"><b>89</b>&nbsp; commits ahead</span>
<span class="fkx-stat"><b>4</b>&nbsp; net-new crates</span>
<span class="fkx-stat"><b>17&rarr;21</b>&nbsp; engine crates</span>
<span class="fkx-stat"><b>1,118</b>&nbsp; files changed</span>
<span class="fkx-stat"><b>6</b>&nbsp; live worktrees</span>
</div>
<div class="fkx-row">
<span class="fkx-pill">Orchestration brain</span>
<span class="fkx-pill">Linear integration</span>
<span class="fkx-pill">Sandbox isolation</span>
<span class="fkx-pill">Git panel</span>
<span class="fkx-pill">Checkpoints</span>
<span class="fkx-pill">Timeline</span>
<span class="fkx-pill">Push pipeline</span>
<span class="fkx-pill">Life bridge</span>
<span class="fkx-pill">Context wizard</span>
</div>
</div>
...
<div id="what-the-fork-adds" class="fkx-wrap">
<p class="fkx-feature-lede">This is the inventory in card form: the visible product surface, the new engine crates, the integration clusters, and the branch-only cloud track that came out of the hack camp. The fuller showcase lives at <a href="https://broomva.tech/d/hackathon-fork-inventory" target="_blank" rel="noopener">broomva.tech/d/hackathon-fork-inventory</a>.</p>
<div class="fkx-statstrip">
<div class="s"><span class="fkx-bignum">89</span><span class="fkx-biglabel">commits ahead</span></div>
<div class="s"><span class="fkx-bignum">1,118</span><span class="fkx-biglabel">files changed</span></div>
<div class="s"><span class="fkx-bignum">+101,906</span><span class="fkx-biglabel">insertions</span></div>
<div class="s"><span class="fkx-bignum">4</span><span class="fkx-biglabel">net-new crates</span></div>
<div class="s"><span class="fkx-bignum">6</span><span class="fkx-biglabel">clean worktrees</span></div>
</div>

<div class="fkx-grid">
<div class="fkx-card">
<div class="hd"><span class="fkx-ic">01</span><div class="ti">Orchestration brain</div><span class="fkx-tag">new crate</span></div>
<div class="fkx-crate">hawthorne-orchestration</div>
<p>The V2 graft: a filesystem-canonical work model where <code>Initiative -&gt; Project -&gt; Task -&gt; Cycle -&gt; Run</code> becomes the runtime noun. A status change is a git diff.</p>
</div>

<div class="fkx-card">
<div class="hd"><span class="fkx-ic">02</span><div class="ti">Linear tracker integration</div><span class="fkx-tag">largest</span></div>
<div class="fkx-crate">hawthorne-linear</div>
<p>OAuth, GraphQL schemas, REST routes, webhook verification, idempotency, mirrored issues/projects/cycles, board UI, workspace-many connections, and delegation plumbing.</p>
</div>

<div class="fkx-card">
<div class="hd"><span class="fkx-ic">03</span><div class="ti">Life Runtime bridge</div><span class="fkx-tag">stage 0</span></div>
<div class="fkx-crate">hawthorne-life</div>
<p>A Rust client to <code>lifed</code> over a Unix socket with protobuf, routed through the session manager so Life can become a provider inside the agent stack.</p>
</div>

<div class="fkx-card">
<div class="hd"><span class="fkx-ic">04</span><div class="ti">Claude Code hooks</div><span class="fkx-tag">new crate</span></div>
<div class="fkx-crate">hawthorne-claude-hooks</div>
<p>Install and uninstall hooks in Claude Code <code>settings.json</code>, powering the <code>advanced.claude_hooks</code> flag from inside Hawthorne.</p>
</div>

<div class="fkx-card">
<div class="hd"><span class="fkx-ic">05</span><div class="ti">Advanced feature flags</div><span class="fkx-tag">platform</span></div>
<ul class="fkx-list">
<li>Worktrees, context meter, git panel, timeline, checkpoints, tile layout, Claude hooks, and slash-skills catalog.</li>
<li>Each capability lands dark by default, with a KB doc next to the flag.</li>
</ul>
</div>

<div class="fkx-card">
<div class="hd"><span class="fkx-ic">06</span><div class="ti">Git panel</div><span class="fkx-tag">live data</span></div>
<p>Status, log, branch, untracked files, and diffs read from engine <code>/v1/git/*</code> routes, plus boot-time repair for older agent folders missing <code>.git</code>.</p>
</div>

<div class="fkx-card">
<div class="hd"><span class="fkx-ic">07</span><div class="ti">Checkpoints and timeline</div><span class="fkx-tag">agent state</span></div>
<p>Snapshot and restore an agent's <code>.hawthorne</code> state before risky runs, then browse every cross-session message, tool call, and result newest-first.</p>
</div>

<div class="fkx-card">
<div class="hd"><span class="fkx-ic">08</span><div class="ti">Push and tunnel pipeline</div><span class="fkx-tag">notify</span></div>
<p>Notify frames on the engine-relay protocol, APNs/FCM loc-key localization, notification policy, and session-status dispatch.</p>
</div>

<div class="fkx-card">
<div class="hd"><span class="fkx-ic">09</span><div class="ti">Interactive MCP questions</div><span class="fkx-tag">human loop</span></div>
<p><code>AskUserQuestion</code> runs through MCP and renders in Dashboard, Board, and AIBoard while staying blocked in headless <code>-p</code> mode.</p>
</div>

<div class="fkx-card">
<div class="hd"><span class="fkx-ic">10</span><div class="ti">Mobile shell and cross-review</div><span class="fkx-tag">native</span></div>
<p>A Capacitor shell with architecture docs, plus a native <code>request_review</code> tool that turns second opinions into a product surface.</p>
</div>

<div class="fkx-card">
<div class="hd"><span class="fkx-ic">11</span><div class="ti">Cloud sandbox track</div><span class="fkx-tag">branch</span></div>
<ul class="fkx-list">
<li>Axis-B sandbox control surface and benchmark harness.</li>
<li>Engine container with Railway runbook and public <code>/healthz</code>.</li>
<li>Architecture specs for pod-per-agent vs pod-per-engine.</li>
</ul>
</div>

<div class="fkx-card">
<div class="hd"><span class="fkx-ic">12</span><div class="ti">Context enablement</div><span class="fkx-tag">branch</span></div>
<p>Import and synthesize workspace, user, company, product, and customer context so every agent run starts with the right substrate loaded.</p>
</div>
</div>

<div class="fkx-note">Evidence status: screenshots and video were captured from a running local build. Linear, phone pairing, and cloud credentials are shown honestly in their pre-connection or branch-only states.</div>
</div>
