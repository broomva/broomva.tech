...
tags:
  ...
  - machine-learning
  - siemens
audio: /audio/writing/iiot-from-edge-to-cloud.mp3
---

![Layered IIoT architecture from field sensors through edge devices to cloud infrastructure with satellite uplinks](/images/writing/iiot-from-edge-to-cloud/hero-opt.png)
