...
image: /images/writing/cancer-pipeline-mini-pc/hero.png
---

![Running a Cancer Pipeline on a $500 Mini PC](/images/writing/cancer-pipeline-mini-pc/hero.png)
...
![Pipeline Overview](/images/writing/cancer-pipeline-mini-pc/pipeline-overview.png)
...
![UMAP Clustering — 17 Leiden clusters from 4,452 tumor cells](/images/writing/cancer-pipeline-mini-pc/umap-clusters.png)
...
![Target Discovery — 14 significant surface targets, FAP highlighted](/images/writing/cancer-pipeline-mini-pc/target-discovery.png)

![Dotplot — Gene expression across all 17 clusters](/images/writing/cancer-pipeline-mini-pc/dotplot-targets.png)
...
![Neoantigen Candidates — Binding affinity vs structural confidence](/images/writing/cancer-pipeline-mini-pc/neoantigen-scatter.png)
