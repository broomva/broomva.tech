...
tags:
  ...
  - EGRI
  - robust-control
audio: /audio/writing/modern-control-stack.mp3
---

<video src="/images/writing/modern-control-stack/modern-control-stack.mp4" autoplay muted loop playsInline style="width:100%;border-radius:8px;margin-bottom:1.5rem"></video>

![The Modern Control Stack — six layered strata from classical PID at the base to AI-driven supervisory control at the top](/images/writing/modern-control-stack/hero-opt.png)
...
![Safety decomposition architecture — performance controller, CBF-QP safety shield, and learning layer as independent, composable modules](/images/writing/modern-control-stack/safety-decomposition-opt.png)
...
![Multi-rate control hierarchy — deterministic zone at milliseconds, LLM supervisory zone at seconds to days](/images/writing/modern-control-stack/multi-rate-hierarchy-opt.png)
...
![Blueprint architecture — governance, harness, orchestration, control kernel, and EGRI auto-improvement as interconnected subsystems](/images/writing/modern-control-stack/blueprint-architecture-opt.png)
