...
![The AI agent greets the vendor and starts collecting structured data through natural conversation](/images/writing/fifa-procurement/agent-chat-start-opt.png)
...
![The agent responds to each input, validates data in real-time, and asks follow-up questions with context](/images/writing/fifa-procurement/agent-chat-response-opt.png)
...
![Progressive data collection — the agent tracks what has been provided and what still needs to be completed](/images/writing/fifa-procurement/agent-chat-progress-opt.png)
...
![The NYNJ Host Committee landing page with FIFA World Cup 2026 branding and the Start Assessment call to action](/images/writing/fifa-procurement/nynj-landing-opt.png)
...
![Philadelphia Soccer 2026 — committed to working with vendors who reflect the city's diversity](/images/writing/fifa-procurement/phila2026-landing-opt.png)
...
![City of Philadelphia 2026 — connecting businesses to opportunities across FIFA, America's 250th, and the MLB All-Star Game](/images/writing/fifa-procurement/cop-landing-opt.png)
...
![Multi-language support — vendors can switch between English and Spanish at any point in the conversation](/images/writing/fifa-procurement/agent-language-selector-opt.png)
...
![The conversational flow — from greeting to data collection to validation, all in natural language](/images/writing/fifa-procurement/agent-conversation-flow.gif)
