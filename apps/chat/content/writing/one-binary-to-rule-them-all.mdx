...
tags:
  ...
  - infrastructure
  - agent-os
image: /images/writing/broomva-cli-rust/social-card-opt.png
...
![The broomva CLI architecture: a single 3.7MB binary with 6 command groups radiating outward](/images/writing/broomva-cli-rust/architecture-opt.png)
