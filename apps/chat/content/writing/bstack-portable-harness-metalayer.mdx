...
links:
  ...
  - label: "Guillermo Rauch — Vercel hires people who know how to use AI (Bloomberg Línea reel)"
    url: "https://www.instagram.com/reel/DXho28KkdCo/"
...
image: /images/writing/bstack-portable-harness-metalayer/hero-cinematic-poster.png
---

<video src="/video/writing/bstack-portable-harness-metalayer/hero-cinematic.mp4" poster="/images/writing/bstack-portable-harness-metalayer/hero-cinematic-poster.png" autoplay muted loop playsinline preload="metadata" style="width:100%;border-radius:12px;margin-bottom:1.5rem;background:#04060d"></video>
...
>
> *Vercel hires "people who know how to use AI — who write good prompts and manage AI agents to maximize results."* — **Guillermo Rauch**, Vercel CEO ([Bloomberg Línea reel](https://www.instagram.com/reel/DXho28KkdCo/))

Two angles on the same thing. Altman is the *demand side*: the world wants two-to-three orders of magnitude more software than humans-typing-alone can produce. Rauch is the *supply side*: the operators who can meet that demand are the ones who manage agents, not the ones who out-type them. v0 itself is the existence proof — Rauch said elsewhere that v0 hit *3,200 PRs merged per day*. That's not a team scaling, it's a substrate scaling. IEEE Spectrum and Emergent VC named it: *"we'll soon have 100x and 1000x engineers."*
...
![The primitives composing the autonomous-development loop (diagram shows the original nine; P10 + P11 joined the contract through the parallel work this post describes)](/images/writing/bstack-portable-harness-metalayer/diagram-nine-primitives-loop.png)
...
- Two new bstack primitives (P8, P9) added in response to bugs the system surfaced about itself — and two more (P10, P11) crystallized in the parallel work that ran while this post was being written
...
If you want to read the spec before installing, the 11 primitives are documented in [`references/primitives.md`](https://github.com/broomva/bstack/blob/main/references/primitives.md) of [broomva/bstack](https://github.com/broomva/bstack). Each one has a *what / how / why / invariant* section, plus the reflexive trigger rules for the four reasoning-enforced ones (P6, P7, P10, P11). The RCS formalization with stability proofs lives in `research/rcs/papers/p0-foundations`.
...
*The chart at the top is generated from `gh api graphql` queries against the broomva user, run on 2026-05-06. Reproducible — anyone can pull their own contribution trajectory the same way. Sources for the industry framing: Sam Altman at the [Federal Reserve conference](https://www.finalroundai.com/blog/sam-altman-says-world-wants-1000x-more-software); Guillermo Rauch on hiring AI-fluent engineers ([Bloomberg Línea Argentina reel](https://www.instagram.com/reel/DXho28KkdCo/)) and on v0's throughput ([How I AI podcast, Feb 2026](https://podcasts.apple.com/us/podcast/guillermo-rauch-vercel-ceo-on-how-v0-hit-3-200-prs/id1809663079)); IEEE Spectrum and Emergent VC on the 100x/1000x engineer framing.*
