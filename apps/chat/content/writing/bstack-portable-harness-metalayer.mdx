...
<video
  src="/video/writing/bstack-portable-harness-metalayer/inflection.mp4"
  poster="/images/writing/bstack-portable-harness-metalayer/chart-throughput-inflection.png"
  autoPlay
  muted
  loop
  playsInline
