...
<video src="/images/writing/rocket-sim-egri/rocket-egri-showcase.mp4" autoplay muted loop playsinline style="width:100%;border-radius:8px;margin-bottom:1.5rem"></video>
...
![144 grid trials altitude distribution — all data points within a 0.445m band, promotion threshold unreached](/images/writing/rocket-sim-egri/grid-sweep-distribution.png)
...
![Wind speed sensitivity — altitude degrades non-linearly while ground hit velocity approaches constraint](/images/writing/rocket-sim-egri/wind-sensitivity.png)
...
![Rod angle vs max altitude — 30-degree angle wastes 30% of altitude on horizontal flight](/images/writing/rocket-sim-egri/rod-angle-sensitivity.png)
...
![Motor configuration comparison — same rocket, same parameters, only motor changed, showing 531% altitude gain](/images/writing/rocket-sim-egri/motor-comparison.png)
...
![Cross-design benchmark — 15 rockets from 31.9m to 2466.3m, 77x altitude range](/images/writing/rocket-sim-egri/cross-design-benchmark.png)
...
![Mutation surface impact — log scale showing motor selection produces 605x more altitude range than launch parameters](/images/writing/rocket-sim-egri/mutation-surface-impact.png)
