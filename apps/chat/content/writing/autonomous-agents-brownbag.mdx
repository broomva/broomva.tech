...
![The seven-layer architecture — foundation through strategy](/images/writing/autonomous-dev-workflows/seven-layers.png)
...
![The control loop — observe, plan, act, verify, adapt](/images/writing/autonomous-dev-workflows/control-loop.png)
...
![The consciousness stack — three substrates merging into persistent context](/images/writing/autonomous-dev-workflows/consciousness-stack.png)
...
![Symphony — multi-agent dispatch and orchestration](/images/writing/autonomous-dev-workflows/symphony-dispatch.png)
...
![EGRI — the recursive self-improvement spiral](/images/writing/autonomous-dev-workflows/egri-loop.png)
...
mutation_surface: ["prompt templates", "tool selection logic", "retry policy"]
promotion_policy:
